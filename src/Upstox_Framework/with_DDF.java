...
public class with_DDF {
	public static void main(String[] args) throws Throwable {
		...
		FileInputStream fis=new FileInputStream("C:\\Users\\Ankush\\OneDrive\\Documents\\Octo.xlsx");
		...
		//enter pwd
		String pwd=((org.apache.poi.ss.usermodel.Sheet) sh).getRow(0).getCell(1).getStringCellValue();
